    ...
    <View style={{ flex: 1, backgroundColor: 'white' }}>
      ...
      <ScrollView contentContainerStyle={styles.scrollViewContainer} showsVerticalScrollIndicator={false} >
        ...
        <View style={styles.container}>
          <Text style={[styles.sectionHeading,{paddingTop:10}]}>About Us</Text>
          ...
          <Text style={styles.subValue}>- Connect with professionals in the biomedical industry</Text>
          <Text style={styles.subValue}>- Access a variety of vendors and suppliers</Text>
          <Text style={styles.subValue}>- List products for a wide audience (manufacturers, service providers, dealers, distributors)</Text>
          <Text style={styles.subValue}>- Receive newsletters and articles from senior biomedical professionals</Text>
          <Text style={styles.subValue}>- Share knowledge and ask questions</Text>
          <Text style={styles.subValue}>- Get quick answers from experienced professionals</Text>

          <Text style={styles.sectionHeading}>Key Features:</Text>
          <Text style={styles.featureTitle}>Industry Insights:</Text>
          <Text style={styles.subValue}>Stay updated with the conferences, workshops, industry events, latest trends and advancements in biomedical engineering. Our app offers real-time news and expert insights from leading professionals, ensuring you never miss a crucial breakthrough or important opportunity to expand your knowledge and network.</Text>
          <Text style={styles.featureTitle}>Career Guidance:</Text>
          <Text style={styles.subValue}>If you are considering a career in biomedical engineering, let us guide you through the various educational paths, job prospects, and skill requirements. Discover internship and job opportunities from top healthcare institutions and companies.</Text>
          <Text style={styles.featureTitle}>Innovation Showcase:</Text>
          <Text style={styles.subValue}>Discover groundbreaking innovations and technological advancements in the healthcare industry. From prosthetics and wearable devices to state-of-the-art imaging technologies, explore the future of medicine at your fingertips.</Text>
          <Text style={styles.featureTitle}>Networking Opportunities:</Text>
          <Text style={styles.subValue}>Connect with like-minded individuals, researchers, and professionals in the biomedical engineering community. Engage in discussions, share knowledge, exchange ideas, and collaborate on projects to contribute to the future of healthcare technology. We encourage discussions, forums, and networking opportunities, fostering a supportive environment for growth and learning.</Text>
